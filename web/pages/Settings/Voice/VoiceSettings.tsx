...
const ttsServiceTabs = {
  ...
  'silero-api-server': 'Silero API Server',
}
...
export const VoiceSettings: Component = () => {
  ...
  const tabs: Tab[] = ['webspeechsynthesis', 'elevenlabs', 'silero-api-server']
    ...
    <>
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class={currentTab() === 'silero-api-server' ? subclass : 'hidden'}>
