...
- **Social Media Information:** We may have pages on social media sites like Instagram, Facebook, Medium, Twitter, YouTube and LinkedIn, as well as Reddit, 4chan, and a [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat). When you interact with our social media pages, we will collect Personal Information that you elect to provide to us, such as your contact details or social media usernames and profile information (collectively, "Social Information"). In addition, the companies that host our social media accounts may provide us with aggregate information and analytics about our social media activity.
...
You can exercise some of these rights through your Agnaistic account. If you are unable to exercise your rights through your account, please send your request in our [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat).
...
**Exercising Your Rights**. California residents can exercise their CCPA privacy rights by sending their request to us on our [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat).
...
**Authorized Agents**. you may submit a rights request through an authorized agent. If you do so, the agent must present signed written permission to act on your behalf and you may also be required to independently verify your identity and submit proof of your residency with us. Authorized agent requests can be submitted to us on our [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat).

## 6. Children

Our Service is not directed to children who are under the age of 18. Agnaistic does not knowingly collect Personal Information from children under the age of 18. If you have reason to believe that a child under the age of 18 has provided Personal Information to Agnaistic through the Service please contact us on our [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat). We will investigate any notification and if appropriate, delete the Personal Information from our systems.
