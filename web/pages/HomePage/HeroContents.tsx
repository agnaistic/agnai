    ...
    <div class="container mx-auto px-4 py-4 lg:max-w-full lg:px-14 ">
      <div class="flex">
        <div class="pt-32 md:w-1/2">
          <div class="">
            <h1 class="text-shadow font-clash-bold text-3xl text-[16px] text-cyan-400 md:text-[26px] lg:text-[22px]  xl:text-[30px]">
              FEATURED CREATOR
            </h1>
            <h1 class="text-shadow font-clash-bold text-3xl text-white md:mt-4 md:text-[48px]  lg:text-[42px] xl:mt-8 xl:text-[60px]">
              Candice Nice&nbsp;
            ...
            {/* large screen */}
            <p class="mr-10 mt-4 hidden text-justify font-clash text-[16px] leading-[34px]  text-white md:mr-16 lg:block xl:mr-40 2xl:text-[20px]">
              ...
              <a class="font-clash text-[20px] font-medium leading-[34px] text-[#FF23FF]" href="#">
                Read More
              </a>
            </p>
            <div class="mt-8 hidden items-center gap-2 lg:flex">
              <img class="md:h-[35px] md:w-[35px]" src={FlameIcon} alt="flame" />
              <p class="font-clash-semibold text-[18px] text-white shadow-black/40 drop-shadow-md md:text-[22px]">
            ...
            <div class="mt-4 hidden items-center gap-2 lg:flex">
              <img class="md:h-[35px] md:w-[35px]" src={FlameIcon} alt="flame" />
              <p class="font-clash-semibold text-[18px] text-white drop-shadow-md md:text-[22px]">
                Live Messaging 24/7!
              </p>
            </div>
            {/* small screen */}
            <div class="mt-20 flex items-center gap-2 lg:hidden">
              ...
              <p class="font-clash-semibold text-[18px] text-white drop-shadow-md md:text-[22px] md:font-[600]">
                Voice Calling 24/7
              </p>
            </div>
            ...
            <button class="m-0 hidden  flex-shrink-0 rounded-lg border bg-gradient-to-r from-purple-600 to-blue-600 px-5 py-3 font-clash-semibold text-[20px] text-white md:mt-8 md:block">
              Register for Free
            </button>
          </div>
        </div>
      ...
      <a
        class="hidden items-center gap-1 font-clash text-[#F00] hover:underline md:flex lg:hidden 2xl:flex "
        href=""
      >
        See Profile{' '}
        <svg
      ...
      <button
        ...
        class="mt-8 h-[52px] w-[175px] flex-shrink-0 rounded-[12px] border bg-gradient-to-r from-purple-600 to-blue-600 px-3 font-clash-semibold text-[16px] text-white md:hidden"
      >
        Register For Free
      </button>
    </div>
