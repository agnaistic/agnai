      ...
      <form onSubmit={onSubmit}>
        <div class="flex flex-col gap-4">
          ...
          <Dropdown
            ...
            value={guest.config.defaultAdapter}
          />
          ...
          <Show when={cfg.config.adapters.includes('horde')}>
            ...
            <Dropdown
              ...
              helperText={<span>Currently set to: {guest.config.hordeModel || 'None'}</span>}
              label="Horde Model"
              value={guest.config.hordeModel}
