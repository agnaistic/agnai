...
const OnlineCreators = () => {
  return (
    <div>
      <div class="container mx-auto w-full px-4 py-3 md:py-10 lg:max-w-full lg:px-14">
        <div class="flex items-center justify-center md:justify-between">
          <p class="font-clash-display-variable text-[26px] font-bold text-white lg:text-[52px]">
            Online{' '}
            <span class="font-clash-display-variable bg-gradient-to-r from-cyan-400 to-yellow-300 bg-clip-text text-[26px] font-bold text-transparent lg:text-[52px]">
              Creators
            </span>
          </p>
        ...
        <div class="mt-6 grid grid-cols-1 gap-6 md:mt-8 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((_) => {
            ...
            const image = faker.image.urlLoremFlickr({ category: 'woman,beautiful,sexy' })
