...
const GradientButton = (props: Props) => {
  ...
  return (
    <button
      class={`mb-3 flex h-12 w-full items-center justify-between rounded-md border border-white bg-gradient-to-r font-bold lg:flex-row-reverse ${gradientFrom} ${gradientTo}  pl-3 pr-[17px] font-display text-xl  md:h-9 md:pr-3 md:text-[15px] `}
    >
