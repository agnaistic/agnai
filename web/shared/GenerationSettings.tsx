  ...
  <>
    <div class="flex flex-col gap-4">
      ...
      <TextInput
        ...
        helperText="How the character definitions are sent to OpenAI. use {{char}} for the characters name from JSON, {{personality}} for personality, {{user}} for you, and {{example_dialogue}} for the example dialogue. Only used if using Turbo model. Example is taken from TavernAI GPT-3.5-Turbo."
